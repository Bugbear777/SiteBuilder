// components/client-page/ClientPreview.tsx
    ...
    <main className="min-h-screen bg-[#f7f4ef] text-slate-900">
      <header className="border-b bg-white/90">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <nav className="hidden items-center gap-6 text-sm font-medium text-slate-600 md:flex">
            <a href="#about" className="hover:text-[#315f72]">
              About
            </a>
            <a href="#services" className="hover:text-[#315f72]">
              Services
            </a>
            <a href="#gallery" className="hover:text-[#315f72]">
              Gallery
            </a>
            <a href="#contact" className="hover:text-[#315f72]">
              Contact
            </a>
          </nav>
      ...
      <section className="relative overflow-hidden bg-[#315f72] text-white">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-6 py-24 md:grid-cols-[1.1fr_0.9fr] md:items-center">
          <div>
            <p className="mb-3 text-sm font-bold uppercase tracking-widest text-[#d9a441]">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <Button className="bg-[#d9a441] text-slate-950 hover:bg-[#c89432]">
                Contact Us
              </Button>
          ...
          <Card className="overflow-hidden border-white/20 bg-white/10 shadow-2xl backdrop-blur">
              ...
              >
                <div className="p-1">
                  <div className="group overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-slate-200">
                    <div className="flex aspect-[4/3] items-center justify-center bg-slate-200 text-slate-500 transition-transform duration-300 group-hover:scale-[1.02]">
                    ...
                    <div className="p-4">
                      ...
                      <p className="mt-1 text-sm text-slate-500">
                        A warm and welcoming area for residents and family.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-lg leading-8 text-white/80">
              We would be happy to talk with you about care options,
              availability, and whether our home is the right fit for your
              family.
            </p>
          </div>
                ...
                <form className="mt-6 space-y-5">
                  <div className="grid gap-5 md:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      <input
                        id="first-name"
                        placeholder="Jane"
                        className="h-10 w-full rounded-md border border-slate-300 px-3 text-sm outline-none focus:border-[#315f72]"
                      />
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      className="min-h-32 w-full rounded-md border border-slate-300 px-3 py-2 text-sm outline-none focus:border-[#315f72]"
                    />
                  </div>
      ...
      <footer className="bg-slate-950 px-6 py-8 text-white">
        <div className="mx-auto flex max-w-7xl flex-col justify-between gap-4 md:flex-row md:items-center">
          ...
          <div className="flex gap-3">
            <a className="rounded-full bg-white/10 px-3 py-2 text-sm hover:bg-white/20">
              Facebook
            </a>
            <a className="rounded-full bg-white/10 px-3 py-2 text-sm hover:bg-white/20">
              Instagram
